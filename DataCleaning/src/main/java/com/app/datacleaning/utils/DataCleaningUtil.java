/**
 * @ClassName DataCleaningUtil
 * @Description TODO
 * @Author zy
 * @Date 2019/6/15 12:04
 * @Version 1.0
 **/
package com.app.datacleaning.utils;
...
/*
 * @Author zhouyang
 * @Description //TODO https://github.com/lihongcang/GeneralDataFormator/blob/master/src/main/java/Producer.java
 * 参考地址：https://github.com/lihongcang/GeneralDataFormator/blob/master/src/main/java/Producer.java
 * @Date 12:04 2019/6/15
 * @Param
 * @return
 **/
public class DataCleaningUtil {
    ...
    public DataCleaningUtil(String clean_data_config_path){
